...
<div id="header">
    <div>
    <?php
    include $_SERVER['DOCUMENT_ROOT'].'/cory2010/modules/header.inc';
    ?>
    </div>
</div>
...
<div id="nav">
    <div>
    <?php
    include $_SERVER['DOCUMENT_ROOT'].'/cory2010/modules/nav.inc';
    ?>
    </div>
</div>
...
<div id="content">
    <div>
        <h1>Contact Me</h1>
        <p>To get in touch with me, you can fill out the form below, send me an <a href="mailto:ckfugate@gmail.com" title="Email Me">email</a>, or contact me on <a href="http://www.facebook.com/people/Cory-Fugate/100000152284103" title="Cory Fugate"> Facebook.</a></p>
   ...
   <form action="/cory2010/pages/contact.html" method="post" id="contactme">
   <fieldset>
...
<div id="footer">
    <div>
    <?php
    include $_SERVER['DOCUMENT_ROOT'].'/cory2010/modules/footer.inc';
    ?>
    </div>
</div>
</div>
...
<script type="text/javascript">
try {
var pageTracker = _gat._getTracker("UA-15220341-1");
