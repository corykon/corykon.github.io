...
})({"fPx1y":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "32d0dfb75059d72d";
"use strict";
...
},{"6d18d6bd340e7473":"786KC","74ad5ea14201648c":"1dldy"}],"cHUge":[function(require,module,exports) {
...
window.testProgressCelebration = (count = 50)=>{
    ...
    const event = new CustomEvent("testProgressCelebration", {
        detail: {
            count
        }
    });
    window.dispatchEvent(event);
    console.log(`\u{1F3AF} Testing Progress Celebration for ${count} Pokemon!`);
};
...
window.simulateCatches = (targetCount)=>{
    ...
    console.log(`\u{1F3AE} Simulating catches to reach ${targetCount} Pokemon...`);
...
},{}]},["fPx1y","1xC6H"], null, "parcelRequire2844")

//# sourceMappingURL=test-celebrations.5059d72d.js.map
