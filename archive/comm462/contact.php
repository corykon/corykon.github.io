...
if($_POST['btnMessage']){
    ...
    if(strtolower($_POST['security']) != ""){
        $errors['security'] = "There was an error.";
    }
...
<html>
    <head>
        <meta charset="UTF-8">
        <meta name="description" content="Contact Cory Fugate, digital designer and web developer." />
        <title>Contact :: Cory Fugate - Digital Designer and Web Developer</title>
           ...
           <fieldset>
            ...
            <label for="security">Security Question: <span class="tiny"><em>(to make sure you're not a computer...)</em></span></label><br />
                <section id="sec">
                    ...
                    7 + 3=-->
                    <input style="display:none;" type="text" id="security" name="security" size="1" />
                <!--</section>-->
