...
<div id="header">
    <div>
    <?php
    include $_SERVER['DOCUMENT_ROOT'].'/oldsite/modules/header.inc';
    ?>
    </div>
</div>
...
<div id="nav">
    <div>
    <?php
    include $_SERVER['DOCUMENT_ROOT'].'/oldsite/modules/nav.inc';
    ?>
    </div>
</div>
...
<div id="content">
   ...
   <form action="/oldsite/pages/contact.php" method="post" id="contactme">
   <fieldset>
...
<div id="footer">
    <div>
    <?php
    include $_SERVER['DOCUMENT_ROOT'].'/oldsite/modules/footer.inc';
    ?>
    </div>
</div>
</div>
