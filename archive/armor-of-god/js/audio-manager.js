class AudioManager {
    constructor() {
        ...
        this.audio = {
            menu: new Audio('sounds/menu-theme.mp3'),
            adventure: new Audio('sounds/level-gameplay-theme.mp3'),
            winner: new Audio('sounds/level-cleared.mp3'),
            victory: new Audio('sounds/level-cleared-final.mp3'),
            gameOver: new Audio('sounds/game-over-sting.mp3'),
            jump: new Audio('sounds/player-jump.wav'),
            armormarch: new Audio('sounds/armormarch.mp3'),
            powerup: new Audio('sounds/armor-activate.mp3'),
            bark1: new Audio('sounds/dog-bark.mp3'),
            meow: new Audio('sounds/meow.mp3'),
            petSparkles: new Audio('sounds/pet-sparkles.mp3'),
            fireworks: new Audio('sounds/level-clear-fireworks.mp3'),
            collect2: new Audio('sounds/collect-scripture.wav'),
            armorFound: new Audio('sounds/armor-found.mp3'),
            thud: new Audio('sounds/thud.mp3'),
            thud2: new Audio('sounds/thud2.mp3'),
            thud3: new Audio('sounds/thud3.mp3'),
            heal2: new Audio('sounds/collect-heart.wav'),
            ricochet: new Audio('sounds/ricochet.mp3'),
            ricochet2: new Audio('sounds/ricochet2.mp3'),
            gameoversong: new Audio('sounds/game-over-theme.mp3'),
            startGameClick: new Audio('sounds/start-game.mp3'),
            buttonClick: new Audio('sounds/button-click.mp3'),
            buttonClick2: new Audio('sounds/speed-slider-tick.mp3'),
            ...
            levelIntro: new Audio('sounds/level-intro-theme.mp3'),
            arrowSmash: new Audio('sounds/impact-smash.mp3'),
            smash: new Audio('sounds/impact-smash.mp3'),
            snailYell: new Audio('sounds/snail-yell.wav'),
            snailPop: new Audio('sounds/snail-pop.wav'),
            falling: new Audio('sounds/fall-impact.mp3'),
            fallingRock: new Audio('sounds/fall-impact.mp3'),
            ...
            golemPet: new Audio('sounds/golem.mp3'),
            ...
            stonesFalling: new Audio('sounds/golem-stones-falling.mp3'),
            earthquakeRumble: new Audio('sounds/golem-earthquake-rumble.mp3'),
            bossFight: new Audio('sounds/golem-boss-theme.mp3'),
            openingCutscene: new Audio('sounds/opening-peaceful-theme.mp3'),
            openingBadNews: new Audio('sounds/opening-danger-theme.mp3'),
        ...
        const audioSettings = {
            ...
            petSparkles: { loop: false, volume: 0.55 },
            fireworks: { loop: false, volume: 0.6 },
            collect2: { loop: false, volume: 0.5 },
            armorFound: { loop: false, volume: 0.6 },
            ...
            golemPet: { loop: false, volume: 0.8, playbackRate: 1.5},
